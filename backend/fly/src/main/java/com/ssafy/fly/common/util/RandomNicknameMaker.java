...
public class RandomNicknameMaker {
    ...
    public static String getNickname() {
        ...
        String animal = animalLst.get(sr.nextInt(animalLst.size()));
        String adjective = adjectiveLst.get(sr.nextInt(adjectiveLst.size()));
        String color = colorLst.get(sr.nextInt(colorLst.size()));
