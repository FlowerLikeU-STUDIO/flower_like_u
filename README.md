...
<img  alt="너닮꽃" src="https://user-images.githubusercontent.com/46440898/202887536-b3ab2791-ff35-4b53-8d65-bc464c65281f.png" style="zoom:;" >
...
| 기능  | 내용                                                         |
| :---- | :----------------------------------------------------------- |
| 기능1 | 드래그 앤 드롭과 추천 기능을 통한 개인 맞춤형 커스텀 꽃다발 제작 기능 |
...
| <img src="https://user-images.githubusercontent.com/46440898/202614640-a1b11618-78e5-414f-98cc-f331f7c72bf0.png" alt="Next.js" width="120px" height="70px" /> | <img src="https://user-images.githubusercontent.com/46440898/202615156-cdc1c752-387e-48a5-a887-6bcc62998f55.svg" alt="Redux" width="50px" height="50px" /> | <img src="https://profilinator.rishav.dev/skills-assets/redux-original.svg" alt="Redux" width="50px" height="50px" /> |
| :-----------------------------------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------: |
|                                                                            Next.js                                                                            |                                                                            SWR                                                                             |                                                         Redux                                                         |

| <img src="https://cdn.worldvectorlogo.com/logos/socket-io.svg" alt="Socket.io" width="50px" height="50px" /> | <img src="https://user-images.githubusercontent.com/46440898/202614490-452fc13c-e725-4656-90ec-ac29ab7a5ca2.svg" alt="Styled-Component" width="50px" height="50px" /> | <img src="https://axios-http.com/assets/logo.svg" alt="MUI" width="50px" height="50px" /> |
| :----------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------: |
...
<img alt="아키텍처" src="https://user-images.githubusercontent.com/46440898/202889686-1a2f0c33-0558-46bf-8954-b9a448d4f471.png" style="zoom:;" />  

### [:notebook_with_decorative_cover: ERD](#  https://www.erdcloud.com/d/LdDEsEQNLmSyWSkwQ )

![image-20221120213111587](images/image-20221120213111587.png) 
...
<td align="start">
- 프로젝트 리더로 프로젝트 매니징 및 일정 관리, 프로젝트 발표 진행 <br/>- Vanilla JavaScript와 Redux를 이용하여 꽃다발 커스텀을 위한 드래그 앤 드롭 기능 구현 <br/>- 유저 친화성을 위한 Session Storage에 커스텀 내역 고정, 편리한 커스텀을 위한 추천 기능, 카카오톡 공유하기와 사진으로 저장하기 등 서비스 주요 기능인 꽃다발 커스텀 전반의 기능 구현 <br/>- 서비스 메인 페이지와 회원가입 기능 구현 <br/>- google analytics & beusable 을 이용한 유저 트래킹 및 분석
</td>
</tr>
<tr>
<td align="center" width="150px">
<a href="[https://github.com/pfcskms1997](https://github.com/pfcskms1997)" target="_blank">
<a href="https://github.com/pfcskms1997"><img height="100px" width="100px" src="https://avatars.githubusercontent.com/u/62384846?v=4" alt="강민성 프로필"/></a>
</a>
</td>
<td align="center" width="150px">
강민성
...
<a href="https://github.com/elqla"><img height="100px" width="100px" src="https://avatars.githubusercontent.com/u/97648343?v=4" alt="박다빈 프로필"/></a>
</a>
</td>
<td align="center" width="150px">
박다빈
...
<td align="start">
- SSG를 적용한 플로리스트 목록 페이지 <br/>- 카카오 맵을 활용한 내주변 꽃가게 <br/>- 구매자 마이페이지 <br/>- 회원정보수정
</td>
</tr>
<tr>
<td align="center" width="150px">
<a href="[https://github.com/clapans](https://github.com/clapans)" target="_blank">
<a href="https://github.com/clapans"><img height="100px" width="100px" src="https://avatars.githubusercontent.com/u/97648260?v=4" alt="박수근 프로필"/></a>
</a>
</td>
<td align="center" width="150px">
박수근
...
<td align="start">
- 채팅 관련 소켓, API 서버 구현 <br/>- JWT를 이용한 Security 구현 <br/>- DB 더미데이터 제작
</td>
</tr>
<tr>
<td align="center" width="150px">
...
<td align="start">
- 초기 스켈레톤 구조 설계 및 작성 <br/>- SEO 최적화 <br/>- 구매자와 판매자간의 비휘발성 채팅 서비스 구현 <br/>- Redux 를 이용한 채팅 상태관리
</td>
</tr>
<tr>
<td align="center" width="150px">
<a href="[https://github.com/sc-choi2022](https://github.com/sc-choi2022)" target="_blank">
<a href="https://github.com/sc-choi2022"><img height="100px" width="100px" src="https://avatars.githubusercontent.com/u/97648355?v=4" alt="최수연 프로필"/></a>
</a>
</td>
<td align="center" width="150px">
최수연
...
<td align="start" >
- Docker와 Jenkins를 이용한 CI/CD 구축 <br />- 메인서버와 채팅서버를 분리하여 채팅서버의 트래픽 분산 <br />- 사설 도메인 연결 및 관리 <br />- EC2에 NGINX reverse proxy를 구축하고 SSL인증서 설정으로 HTTPS을 적용 <br />- FrontEnd와 BackEnd의 기술스택에 맞는 웹서버 아키텍쳐를 구축 (Spring boot, Next.js, MySQL, MongoDB)
</td>
</tr>
</table>
...
|                            커스텀                            |                          커스텀                          |
| :----------------------------------------------------------: | :------------------------------------------------------: |
| ![2.커스텀 1](images/2.%EC%BB%A4%EC%8A%A4%ED%85%80%201.webp) | ![2.커스텀2](images/2.%EC%BB%A4%EC%8A%A4%ED%85%802.webp) |
...
|                       플로리스트 목록                        |                        내 주변 꽃가게                        |
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| ![3. 플로리스트목록](images/3.%20%ED%94%8C%EB%A1%9C%EB%A6%AC%EC%8A%A4%ED%8A%B8%EB%AA%A9%EB%A1%9D.webp) | ![3. 내 주변 꽃가게](images/3.%20%EB%82%B4%20%EC%A3%BC%EB%B3%80%20%EA%BD%83%EA%B0%80%EA%B2%8C.webp) |
...
|                         메인 페이지                          |                      판매자 마이페이지                       |
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| ![4. 메인페이지](images/4.%20%EB%A9%94%EC%9D%B8%ED%8E%98%EC%9D%B4%EC%A7%80.webp) | ![4. 판매자 마이페이지](images/4.%20%ED%8C%90%EB%A7%A4%EC%9E%90%20%EB%A7%88%EC%9D%B4%ED%8E%98%EC%9D%B4%EC%A7%80.webp) |
...
|                        판매자 프로필                         |                             채팅                             |
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| ![4. 판매자 프로필1](images/4.%20%ED%8C%90%EB%A7%A4%EC%9E%90%20%ED%94%84%EB%A1%9C%ED%95%841.webp) | ![4. 판매자 프로필2](images/4.%20%ED%8C%90%EB%A7%A4%EC%9E%90%20%ED%94%84%EB%A1%9C%ED%95%842.webp) |
...
|                      구매자 마이페이지                       |                        회원 정보 수정                        |
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| ![5. 구매자 마이페이지](images/5.%20%EA%B5%AC%EB%A7%A4%EC%9E%90%20%EB%A7%88%EC%9D%B4%ED%8E%98%EC%9D%B4%EC%A7%80.webp) | ![5. 정보수정](images/5.%20%EC%A0%95%EB%B3%B4%EC%88%98%EC%A0%95.webp) |
...
|                           로그인                           |                           회원가입                           |
| :--------------------------------------------------------: | :----------------------------------------------------------: |
| ![6. 로그인](images/6.%20%EB%A1%9C%EA%B7%B8%EC%9D%B8.webp) | ![6. 회원가입](images/6.%20%ED%9A%8C%EC%9B%90%EA%B0%80%EC%9E%85.webp) |
