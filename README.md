...
<td align="start" >
- Docker와 Jenkins를 이용한 CI/CD 구축 <br />- 메인서버와 채팅서버를 분리하여 채팅서버의 트래픽 분산 <br />- 사설 도메인 연결 및 관리 <br />- Nginx을 사용하여 서버에 SSL인증 및 Reverse Proxy 적용 <br />- Spring boot, Next.js, MySQL, MongoDB 배포
</td>
</tr>
</table>
